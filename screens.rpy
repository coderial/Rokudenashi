...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("이전") action Rollback()
...
screen main_menu():
    ...
    frame:
        background "gui/menu_container.png"
        xsize 448
        ysize 720
        xpos 0
    ...
    imagebutton auto "gui/button/START_%s.png" action Start() xalign .05 yalign .2

    imagebutton auto "gui/button/LOAD_%s.png" action Show("load") xalign .05 yalign .4

    imagebutton auto "gui/button/OPTION_%s.png" action Show("preferences") xalign .05 yalign .6

    imagebutton auto "gui/button/EXIT_%s.png" action Quit() xalign .05 yalign .8
